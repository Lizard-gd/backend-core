...
--changeset Lizard:BCORE-33-1
--comment: Создание junction таблицы deal_product для связи сделок и продуктов
...
--rollback DROP TABLE deal_product;